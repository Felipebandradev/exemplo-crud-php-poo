...
$dados_fabricante = $fabricante->lerUmFabricante();
...
<body>
    <div class="container">
        ...
        <form action="" method="post">
            <input type="hidden" name="id" value="<?=$dados_fabricante['id']?>">
            <p>
                <label for="nome">Nome:</label>
                <input value="<?=$dados_fabricante['nome']?>" required type="text" name="nome" id="nome">
            </p>
